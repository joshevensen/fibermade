    ...
    >
        ...
        <div class="mt-10 flex items-center gap-x-6 lg:mt-0 lg:shrink-0">
            ...
            <UiLink
                ...
                class="text-sm/6 font-semibold text-gray-900 hover:opacity-80 dark:text-gray-100"
            >
    ...
    <div v-else class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mt-10 flex items-center gap-x-6">
            ...
            <UiLink
                v-if="secondaryButton"
                :href="secondaryButton.href"
                class="text-sm/6 font-semibold text-gray-900 dark:text-gray-300 dark:hover:text-white"
            >
                {{ secondaryButton.text }}
                <span aria-hidden="true">→</span>
            </UiLink>
