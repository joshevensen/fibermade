            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <div
                        ...
                        "
                        class="rounded-lg border border-dashed border-surface-200 bg-surface-50 py-4 text-center text-sm text-surface-500"
                    >
                        No orders
                    </div>
                    <ul v-else class="space-y-1">
                        ...
                        >
                            <Link
                                ...
                                class="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-surface-200 px-3 py-2 text-left transition-colors hover:border-surface-300 hover:bg-surface-50"
                            >
                                <div class="min-w-0">
