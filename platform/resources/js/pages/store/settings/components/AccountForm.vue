...
const { form, onSubmit } = useFormSubmission({
    route: updateAccount,
    initialValues,
    successMessage: 'Store account updated successfully.',
});
</script>

<template>
    <UiCard>
        <template #title>Store Account Information</template>
        <template #subtitle>Update your store details</template>
        <template #content>
