                        ...
                        <dl class="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none dark:text-gray-400">
                            ...
                            >
                                <dt class="inline font-semibold text-gray-900 dark:text-white">
                                    <i
                                        v-if="feature.icon"
                                        :class="[feature.icon, 'absolute top-1 left-1 size-5 text-indigo-600 dark:text-indigo-400']"
                                        aria-hidden="true"
                                    ></i>
                                    {{ feature.name }}
                                </dt>
                ...
                <dl class="col-span-3 grid grid-cols-1 gap-x-8 gap-y-10 text-base/7 text-gray-600 sm:grid-cols-2 lg:gap-y-16 dark:text-gray-400">
                    ...
                    >
                        <dt class="font-semibold text-gray-900 dark:text-white">
                            <i
                                v-if="feature.icon"
                                :class="[feature.icon, 'absolute top-1 left-0 size-5 text-indigo-500 dark:text-indigo-400']"
                                aria-hidden="true"
                            ></i>
                            {{ feature.name }}
                        </dt>
